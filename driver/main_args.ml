...
module Default = struct
  ...
  module Common = struct
    ...
    let _require arg = match String.contains arg Filename.dir_sep.[0] with
      | true -> requires_rev := (`File_and_deps arg :: (!requires_rev))
      | false ->
          match Lib.Name.of_string arg with
          | Ok lib -> requires_rev := (`Lib lib :: (!requires_rev))
